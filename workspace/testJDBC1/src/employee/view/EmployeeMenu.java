...
public class EmployeeMenu {
	...
	public void display() {
		do {
			...
			switch(no) {
			case 1:	printList(econtroll.selectList());
					break;
			case 2:	System.out.println(econtroll.selectEmp(inputEmpId()));
					break;
			case 3:	econtroll.insertEmp(inputEmp());
					break;
			case 4:	econtroll.updateEmp(modifyEmp());
					break;
			case 5:	if(econtroll.deleteEmp(inputEmpId()) > 0) {
						System.out.println("성공적으로 삭제되었습니다.");
					}else {
						System.out.println("직원 삭제 실패!");
					}
					break;
			case 6:	printList(econtroll.selectDept(inputDeptId()));
					break;
			case 7:	printList(econtroll.selectJob(inputJobId()));
					break;
