...
public class Menu {
	// Field
	// 의존선 주입(DI : Dependency Injection) => 의존관계 만듦
	...
	public static void display() {
		...
		do {
			...
			System.out.println("7. HashMap 사용 테스트");
			System.out.println("8. HashMap 사용 테스트 : 연속 처리");
...
//				System.exit(0); // 프로그램 강제 종료함
				return;
			default:
				System.out.println("잘못 입력하셨습니다. 확인하고 다시 입력하세요.");
			}
		} while (true);
	}
}
